...
export const Exercise = () => {
  function examplesStrings() {
    let sample = 'Sample';
    const przyklad = [];
    for (let index = 0; index < sample.lenght; index++) {
    ...
    return {
      tekst: 'Omega',
      tablica: ['Alfa', 'Beta'],
      tekstLength: 'jdhahdkaj'.length,
      tablicaLength: ['Alfa', 'Beta'].length,
      sample,
      przyklad: przyklad.join(''),
      simple: [...sample]
        .map(function (litera) {
          return litera + '-';
        })
  ...
  function excercises() {
    ...
    function toCamelCase() {
      ...
      //   const wynik = firstLetter.toUppperCase() + rest.join('');
      //   return wynik;
      // });
    }
