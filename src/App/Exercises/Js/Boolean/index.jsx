...
export function Exercise() {
  ...
  return (
    <div>
      ...
      <ul>
        <li>
          True/False {'->'} data validation, e.g., whether e-mail is correct.
        </li>
        <li>
          Flag variable {'->'} e.g., whether user has an access to crtain code
          or is logged in.
        </li>
        <li>Error handling.</li>
        <li>
          College logic classes may remind you of how boolean works and what are
          they for.
        </li>
      </ul>
      <h3>Examples</h3>
